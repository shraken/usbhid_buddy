...
//    -Updated hid_configuration_descriptor extern definition
//    -02 APR 2010
// Release 1.1
...
extern const hid_configuration_descriptor code HIDCONFIGDESC;
   ...
   {                          // interface, or EP
      ...
      case OUT_ENDPOINT:               // See if recipient was an endpoint
         ...
         {                             // otherwise return stall to host
            //printf("Force_Stall 6\r\n");
            Force_Stall();
         }
         else
         {
         // Handle case if request is directed to EP 2
...
{                                      // and size to correct descriptor and
   ...
   case DSC_HID_REPORT:                // HID Specific (HID report descriptor)
      ...
      default:
         //printf("Force_Stall 16\r\n");
         //printf("MSB = %d, LSB = %d\r\n", MSB, LSB);
         //printf("SETUP.wValue.c[MSB] = %d\r\n", SETUP.wValue.c[MSB]);
         //printf("SETUP.wValue.c[LSB] = %d\r\n", SETUP.wValue.c[LSB]);
         //printf("SETUP.wValue.i = %d\r\n", SETUP.wValue.i);
