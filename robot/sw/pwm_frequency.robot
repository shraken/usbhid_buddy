...
BUDDY_PWM_FREQUENCY_R0005
    [Documentation]  Buddy PWM static frequency values check on all channels
    ...
    \    Buddy Static PWM Frequency Check  ${channel}